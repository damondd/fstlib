...
class IFstTable
{
  public:
	...
	// Reader interface
  	...
  	virtual void SetIntegerColumn(IIntegerColumn* integerColumn, int colNr, const std::string& annotation) = 0;
    ...
    virtual void SetDoubleColumn(IDoubleColumn* doubleColumn, int colNr, const std::string& annotation) = 0;
